...
Public Class XL_NGHIEP_VU
    Public Function Tra_cuu_San_pham(Chuoi_Tra_cuu As String, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As List(Of XL_SAN_PHAM)
        ...
        Return Danh_sach
    End Function
    Public Function Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung As XL_QUAN_LY_CUA_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As List(Of XL_SAN_PHAM)
        Dim Danh_sach_San_pham_Quan_ly = New List(Of XL_SAN_PHAM)
        Danh_sach_San_pham.ForEach(
            Sub(San_pham)
                ...
                If Duoc_Phan_quyen Then
                    Danh_sach_San_pham_Quan_ly.Add(San_pham)
                End If
            End Sub)
        Return Danh_sach_San_pham_Quan_ly
    End Function
    Public Function Tao_Danh_sach_San_pham_NVBH(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As List(Of XL_SAN_PHAM)
        Dim Danh_sach_San_pham_NVBH = New List(Of XL_SAN_PHAM)
        Danh_sach_San_pham.ForEach(
            Sub(San_pham)
                Dim Duoc_Phan_quyen = Nguoi_dung.Danh_sach_Nhom_San_pham.Any(Function(Nhom_San_pham) Nhom_San_pham.Ma_so = San_pham.Nhom_San_pham.Ma_so)
                If Duoc_Phan_quyen Then
                    Danh_sach_San_pham_NVBH.Add(San_pham)
                End If
            End Sub)
        Return Danh_sach_San_pham_NVBH
    End Function
    ...
    Public Function Tinh_Doanh_thu_Nam_Hien_hanh_San_pham(San_pham As XL_SAN_PHAM) As Long
        ...
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Ngay_Hien_hanh_Quan_ly(Nguoi_dung As XL_QUAN_LY_CUA_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Quan_ly As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_Quan_ly.Sum(Function(San_pham) Tinh_Doanh_thu_Ngay_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Thang_Hien_hanh_Quan_ly(Nguoi_dung As XL_QUAN_LY_CUA_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Quan_ly As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_Quan_ly.Sum(Function(San_pham) Tinh_Doanh_thu_Thang_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Nam_Hien_hanh_Quan_ly(Nguoi_dung As XL_QUAN_LY_CUA_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Quan_ly As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_Quan_ly.Sum(Function(San_pham) Tinh_Doanh_thu_Nam_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Ngay_Hien_hanh_NVBH(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_NVBH As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_NVBH(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_NVBH.Sum(Function(San_pham) Tinh_Doanh_thu_Ngay_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Thang_Hien_hanh_NVBH(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_NVBH As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_NVBH(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_NVBH.Sum(Function(San_pham) Tinh_Doanh_thu_Thang_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Nam_Hien_hanh_NVBH(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_NVBH As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_NVBH(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_NVBH.Sum(Function(San_pham) Tinh_Doanh_thu_Nam_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    ...
    End Function
    Public Function Tinh_Tong_So_luong_Ton_San_pham(Nguoi_dung As XL_QUAN_LY_CUA_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Quan_ly As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung, Danh_sach_San_pham)
        Dim Tong_So_luong_ton = Danh_sach_San_pham_Quan_ly.Sum(Function(San_pham) Tinh_So_luong_Ton_San_pham(San_pham))
...
#Region "Xử lý Đọc"
    ...
    Public Function Doc_Nhi_phan_Hinh(Ma_so As String) As Byte()
        ...
        If Ma_so.Contains("NV") Or Ma_so.Contains("PET") Then
            Kieu_Hinh = ".png"
        End If
        If Ma_so.Contains("COM") Or Ma_so.Contains("KHAI_VI") Or Ma_so.Contains("MY_Y") Or Ma_so.Contains("THUC_UONG") Or Ma_so.Contains("PIAZZA") Or Ma_so.Contains("SALAD") Then
            Kieu_Hinh = ".jpg"
        End If
