Public Class MH_Chinh
    ...
    Sub Khoi_dong(Nguoi_dung_Dang_nhap As XL_QUAN_LY_CUA_HANG)
        ...
        Th_Tieu_de.Text = "Cửa hàng bán Piazza PET - Quản lý Cửa hàng"
    ...
    Sub Kich_hoat_MH_Xem_Danh_sach_San_pham(Danh_sach_San_pham As List(Of XL_SAN_PHAM), Nguoi_dung As XL_QUAN_LY_CUA_HANG)
