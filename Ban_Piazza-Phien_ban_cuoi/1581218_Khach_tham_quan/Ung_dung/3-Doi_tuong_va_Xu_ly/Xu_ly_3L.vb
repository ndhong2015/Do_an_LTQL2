...
Public Class XL_NGHIEP_VU
    Public Function Tra_cuu_San_pham(Chuoi_Tra_cuu As String, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As List(Of XL_SAN_PHAM)
        ...
        Return Danh_sach
    End Function
    Public Function Tao_Danh_sach_San_pham_Nhan_vien(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As List(Of XL_SAN_PHAM)
        Dim Danh_sach_San_pham_Nhan_vien = New List(Of XL_SAN_PHAM)
        Danh_sach_San_pham.ForEach(
            Sub(San_pham)
                ...
                If Duoc_Phan_quyen Then
                    Danh_sach_San_pham_Nhan_vien.Add(San_pham)
                End If
            End Sub)
        Return Danh_sach_San_pham_Nhan_vien
    End Function
    ...
    Public Function Tinh_Tong_Doanh_thu_Ngay_Hien_hanh_Nhan_vien(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Nhan_vien As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Nhan_vien(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_Nhan_vien.Sum(Function(San_pham) Tinh_Doanh_thu_Ngay_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Thang_Hien_hanh_Nhan_vien(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Nhan_vien As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Nhan_vien(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_Nhan_vien.Sum(Function(San_pham) Tinh_Doanh_thu_Thang_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Nam_Hien_hanh_Nhan_vien(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Nhan_vien As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Nhan_vien(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_Nhan_vien.Sum(Function(San_pham) Tinh_Doanh_thu_Nam_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    ...
    End Function
    Public Function Tinh_Tong_So_luong_Ton_San_pham(Nguoi_dung As XL_NHAN_VIEN_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Nhan_vien As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Nhan_vien(Nguoi_dung, Danh_sach_San_pham)
        Dim Tong_So_luong_ton = Danh_sach_San_pham_Nhan_vien.Sum(Function(San_pham) Tinh_So_luong_Ton_San_pham(San_pham))
...
Public Class XL_LUU_TRU
    ...
    Dim Thu_muc_Phieu_dat As DirectoryInfo = Thu_muc_Du_lieu.GetDirectories("Phieu_dat")(0)
...
#Region "Xử lý Đọc"
    ...
    Public Function Doc_Du_lieu() As XL_DU_LIEU ' Chưa xử lý Caching
        ...
        Kq.Danh_sach_Phieu_dat = Doc_Danh_sach_Phieu_dat()
        Return Kq
    End Function
    ...
    Function Doc_Danh_sach_San_pham() As List(Of XL_SAN_PHAM)
        ...
        Return Danh_sach
    End Function
    Function Doc_Danh_sach_Phieu_dat() As List(Of XL_DAT_HANG)
        Dim Danh_sach As New List(Of XL_DAT_HANG)
        Thu_muc_Phieu_dat.GetFiles("*.json").ToList.ForEach(
            Sub(Tap_tin)
                Dim Chuoi_JSON = File.ReadAllText(Tap_tin.FullName)
                Dim Phieu_dat = JsonConvert.DeserializeObject(Of XL_DAT_HANG)(Chuoi_JSON)
    ...
    Public Function Doc_Nhi_phan_Hinh(Ma_so As String) As Byte()
        ...
        If Ma_so.Contains("NV") Or Ma_so.Contains("PET") Then
            Kieu_Hinh = ".png"
        End If
        If Ma_so.Contains("KHACH_HANG") Then
            Ma_so = "KHACH_HANG"
            Kieu_Hinh = ".png"
        End If
...
#Region "Xử lý Ghi"
    Public Function Ghi_Ban_hang_Moi(San_pham As XL_SAN_PHAM, Ban_hang As XL_BAN_HANG) As String
        ...
        Return Kq
    End Function
    Public Function Ghi_Phieu_Dat_Moi(Dat_hang As XL_DAT_HANG, Danh_sach_Phieu_dat As List(Of XL_DAT_HANG)) As String
        Dim Kq As String = ""
        Danh_sach_Phieu_dat.Add(Dat_hang)
        Try
            Dim Duong_dan = Thu_muc_Phieu_dat.FullName & "\" & Dat_hang.Ma_so & ".json"
            Dim Chuoi_JSON = JsonConvert.SerializeObject(Dat_hang)
            File.WriteAllText(Duong_dan, Chuoi_JSON)
            Kq = "OK"
        Catch Loi As Exception
            Kq = Loi.Message
        End Try
        If Kq <> "OK" Then
            Danh_sach_Phieu_dat.Remove(Dat_hang)
        End If
        Return Kq
    End Function
#End Region
