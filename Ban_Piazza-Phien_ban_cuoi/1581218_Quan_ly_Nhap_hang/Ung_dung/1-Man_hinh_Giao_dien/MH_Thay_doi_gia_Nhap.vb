Public Class MH_Thay_doi_gia_Nhap
    ...
    Sub Xuat_San_pham()
        ...
        Dim Th_Don_gia_Nhap As New TextBox
        Th_Ho_so.Controls.Add(Th_Don_gia_Nhap)
        Dim Don_gia As Long = San_pham.Don_gia_Nhap
        Th_Don_gia_Nhap.Text = Don_gia
...
Sub()
    Dim Hop_le = Integer.TryParse(Th_Don_gia_Nhap.Text, Don_gia) _
                 AndAlso Don_gia > 0
    If Hop_le Then
        San_pham.Don_gia_Nhap = Th_Don_gia_Nhap.Text
        Dim Kq As String = Luu_tru.Cap_nhat_gia_Nhap(San_pham)
        If (Kq = "OK") Then
            MessageBox.Show("Đã cập nhật giá nhập sản phẩm")
    ...
    Else
        Th_Don_gia_Nhap.Text = San_pham.Don_gia_Ban
