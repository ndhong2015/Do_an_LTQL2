...
Public Class XL_NGHIEP_VU
    Public Function Tra_cuu_San_pham(Chuoi_Tra_cuu As String, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As List(Of XL_SAN_PHAM)
        ...
        Return Danh_sach
    End Function
    Public Function Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung As XL_QUAN_LY_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As List(Of XL_SAN_PHAM)
    ...
    Public Function Tinh_Doanh_thu_Nam_Hien_hanh_San_pham(San_pham As XL_SAN_PHAM) As Long
        ...
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Ngay_Hien_hanh_Quan_ly(Nguoi_dung As XL_QUAN_LY_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        ...
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Thang_Hien_hanh_Quan_ly(Nguoi_dung As XL_QUAN_LY_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Quan_ly As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung, Danh_sach_San_pham)
        Dim Doanh_thu = Danh_sach_San_pham_Quan_ly.Sum(Function(San_pham) Tinh_Doanh_thu_Thang_Hien_hanh_San_pham(San_pham))
        Return Doanh_thu
    End Function
    Public Function Tinh_Tong_Doanh_thu_Nam_Hien_hanh_Quan_ly(Nguoi_dung As XL_QUAN_LY_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Quan_ly As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung, Danh_sach_San_pham)
    ...
    End Function
    Public Function Tinh_Tong_So_luong_Ton_San_pham(Nguoi_dung As XL_QUAN_LY_BAN_HANG, Danh_sach_San_pham As List(Of XL_SAN_PHAM)) As Long
        Dim Danh_sach_San_pham_Quan_ly As List(Of XL_SAN_PHAM) = Tao_Danh_sach_San_pham_Quan_ly(Nguoi_dung, Danh_sach_San_pham)
...
#Region "Xử lý Ghi"
    Public Function Ghi_Ban_hang_Moi(San_pham As XL_SAN_PHAM, Ban_hang As XL_BAN_HANG) As String
        ...
        Return Kq
    End Function
    Public Function Cap_nhat_gia_Ban(San_pham As XL_SAN_PHAM) As String
        Dim Kq As String = ""
        Try
            Dim Duong_dan = Thu_muc_San_pham.FullName & "\" & San_pham.Ma_so & ".json"
            Dim Chuoi_JSON = JsonConvert.SerializeObject(San_pham)
