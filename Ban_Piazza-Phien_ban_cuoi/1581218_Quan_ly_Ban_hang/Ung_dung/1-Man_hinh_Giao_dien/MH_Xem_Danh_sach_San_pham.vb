Public Class MH_Xem_Danh_sach_San_pham
    ...
    End Sub
    Sub Khoi_dong(Danh_sach_San_pham_Xem As List(Of XL_SAN_PHAM), Nguoi_dung As XL_QUAN_LY_BAN_HANG)
        ...
        Danh_sach_San_pham.ForEach(
            Sub(San_pham)
                ...
                Dim Chuoi_Thong_tin As String = $"<div Class='text-left float-left' style='width:65%;height:100%;margin-left:10px;'> " +
                                     ...
                                     $"<br /><i><b><input type='button' style='Background-color:red' value='THAY ĐỔI GIÁ BÁN'><i><b>" +
                                     $"</div>"
    ...
    End Sub
    Sub Kich_hoat_Man_hinh_Xu_ly_tren_San_pham_Chon(San_pham As XL_SAN_PHAM, Nguoi_dung As XL_QUAN_LY_BAN_HANG)
        Dim Khung_Chuc_nang As Control = Me.Parent
        Khung_Chuc_nang.Controls.Clear()
        Dim Mh = New MH_Thay_doi_gia_ban()
