Public Class MH_Cap_nhat_Don_gia_Nhap_Tivi
    ...
    Sub Xuat_Tivi()
        ...
        Th_Don_gia_Nhap.Text = Tivi.Don_gia_Nhap
        ...
        AddHandler Th_Dong_y.Click,
            Sub()
                Dim Don_gia_Nhap As Integer = 1
                Dim Hop_le = Integer.TryParse(Th_Don_gia_Nhap.Text, Don_gia_Nhap) AndAlso Don_gia_Nhap > 0
                If Hop_le Then

                    Dim Kq As String = Luu_tru.Cap_nhat_Don_gia_Nhap_Tivi(Tivi, Don_gia_Nhap)
                    If (Kq = "OK") Then
