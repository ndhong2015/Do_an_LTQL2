...
#Region "Xử lý Ghi"
    Public Function Ghi_Nhap_hang_Moi(San_pham As XL_SAN_PHAM, Nhap_hang As XL_NHAP_HANG) As String
        Dim Kq As String = ""
        San_pham.Danh_sach_Nhap_hang.Add(Nhap_hang)
        Try
        ...
        End Try
        If Kq <> "OK" Then
            San_pham.Danh_sach_Nhap_hang.Remove(Nhap_hang)
        End If
        Return Kq
    End Function
#End Region
