Public Class MH_Chinh
    ...
    Sub Khoi_dong(Nguoi_dung_Dang_nhap As XL_QUAN_LY_CUA_HANG)
        Dim Chuc_nang_1 As New XL_CHUC_NANG()
        Chuc_nang_1.Ten = "Xem Thông tin Nhóm Tivi"
        Chuc_nang_1.Ma_so = "XEM_NHOM_TIVI"
        Dim Chuc_nang_2 As New XL_CHUC_NANG()
        Chuc_nang_2.Ten = "Doanh thu, Số lượng tồn"
        Chuc_nang_2.Ma_so = "XEM_DOANH_THU_SO_LUONG_TON"
        Danh_sach_Chuc_nang.Add(Chuc_nang_1)
        Danh_sach_Chuc_nang.Add(Chuc_nang_2)
        Nguoi_dung = Nguoi_dung_Dang_nhap
        Th_Tieu_de.Text = "Cửa hàng Tivi PET - Quản lý Cửa hàng"
        ...
        Danh_sach_Chuc_nang.ForEach(
            Sub(Chuc_nang)
                ...
                Sub()
                    ...
                    End If
                    If Chuc_nang.Ma_so = "XEM_DOANH_THU_SO_LUONG_TON" Then
                        Kich_hoat_MH_Xem_Doanh_thu_ngay_cua_Nhan_vien()
                    End If
                End Sub
            End Sub)
    ...
    Sub Kich_hoat_MH_Xem_Danh_sach_Nhom_Tivi()
        ...
        Khung_Chuc_nang.Controls.Add(Mh)
    End Sub
    Sub Kich_hoat_MH_Xem_Doanh_thu_ngay_cua_Nhan_vien()
        Khung_Chuc_nang.Controls.Clear()
        Dim Mh = New MH_Xem_Doanh_thu_ngay_cua_Nhan_vien()
        Mh.Khoi_dong(Du_lieu)
        Mh.Dock = DockStyle.Fill
        Khung_Chuc_nang.Controls.Add(Mh)
    End Sub
